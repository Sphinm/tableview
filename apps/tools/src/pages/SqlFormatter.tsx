      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-3 sm:p-4 mb-4 flex flex-wrap items-center justify-between gap-3 shadow-2xs">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 text-xs text-slate-500">
            ...
            <select
              ...
              className="bg-white border border-slate-200 text-slate-700 text-xs font-mono font-medium rounded-lg px-2.5 py-1 focus:outline-none focus:border-cyan-500 shadow-2xs cursor-pointer"
            >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3.5 py-1.5 rounded-lg text-xs font-semibold bg-indigo-600 hover:bg-indigo-500 text-white transition-all cursor-pointer flex items-center gap-1.5 shadow-2xs active:scale-95"
