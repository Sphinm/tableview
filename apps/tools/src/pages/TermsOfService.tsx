    ...
    <div className="relative -mx-4 sm:-mx-6 lg:-mx-8 -my-6 bg-slate-50 text-slate-900 min-h-[calc(100vh-7rem)]"><div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="space-y-10 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p className="text-slate-800 mb-3">You agree not to:</p>
        ...
        <section>
          ...
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-2xs text-xs sm:text-sm text-slate-800 leading-relaxed font-mono">
        ...
        <section>
          ...
          <p className="text-slate-800">
            ...
            <a href="mailto:support@tableview.dev" className="text-indigo-600 hover:text-indigo-800 underline font-medium">
