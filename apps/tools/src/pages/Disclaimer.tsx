...
export const Disclaimer = () => {
  ...
  return (
    <div className="relative -mx-4 sm:-mx-6 lg:-mx-8 -my-6 bg-slate-50 text-slate-900 min-h-[calc(100vh-7rem)]"><div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      {/* Header */}
      <div className="mb-10 pb-8 border-b border-slate-200">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-amber-50 border border-amber-200 text-amber-800 mb-4 shadow-2xs">
      ...
      {/* Core Warning Box */}
      <div className="p-6 rounded-2xl bg-amber-50/70 border border-amber-200 shadow-2xs mb-12">
        <div className="flex items-start gap-4">
          <div className="p-2.5 rounded-xl bg-amber-100 text-amber-800 border border-amber-300 shrink-0 mt-0.5">
      ...
      <div className="space-y-10 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p className="text-slate-800">
            ...
            <a href="mailto:support@tableview.dev" className="text-indigo-600 hover:text-indigo-800 underline font-semibold">
