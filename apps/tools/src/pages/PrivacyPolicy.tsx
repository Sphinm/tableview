...
export const PrivacyPolicy = () => {
  return (
    <div className="relative -mx-4 sm:-mx-6 lg:-mx-8 -my-6 bg-slate-50 text-slate-900 min-h-[calc(100vh-7rem)]"><div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-2xs mb-12">
        <div className="flex items-start gap-4">
          <div className="p-2.5 rounded-xl bg-indigo-50 text-indigo-700 border border-indigo-200 shrink-0 mt-0.5">
      ...
      <div className="space-y-10 text-sm leading-relaxed">
        ...
        <section id="advertising" className="scroll-mt-24">
          ...
          <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-2xs space-y-3 text-xs sm:text-sm text-slate-800 mb-4">
            <p>
        ...
        <section>
          ...
          <p className="text-slate-800">
            ...
            <a href="mailto:privacy@tableview.dev" className="text-indigo-600 hover:underline font-semibold">
