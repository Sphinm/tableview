...
export default function CapRateCalculator() {
  ...
  const handleSelectPreset = (preset: CalculatorPreset<RentalPropertyInput>) => {
    ...
    if (preset.values) {
      setForm(preset.values as RentalPropertyInput);
    }
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 space-y-6">
        ...
        <PageHeader
          ...
          badge={{
            label: 'Institutional Real Estate',
            tone: 'indigo'
          }}
          description="Underwrite residential & commercial rental acquisitions. Calculate pure Net Operating Income (NOI), Cap Rate, Cash-on-Cash Return, and 10-year equity projections."
          actions={
            <>
              <button
                type="button"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs relative overflow-hidden">
            <div className="flex items-center justify-between text-slate-500 mb-1.5">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-600 flex items-center gap-1">
                Capitalization Rate
                <InfoTooltip content="Cap Rate = Annual NOI / Purchase Price. Represents the unleveraged property yield independent of financing structure." />
              </span>
          ...
          <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs relative overflow-hidden">
            <div className="flex items-center justify-between text-slate-500 mb-1.5">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-600 flex items-center gap-1">
                Cash-on-Cash Return
                <InfoTooltip content="Cash-on-Cash Return = Annual Net Cash Flow / Total Initial Cash Invested (Down Payment + Closing Costs + Rehab). Measures immediate leveraged dividend yield." />
              </span>
          ...
          <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs relative overflow-hidden">
            <div className="flex items-center justify-between text-slate-500 mb-1.5">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-600 flex items-center gap-1">
                Net Cash Flow
                <InfoTooltip content="Net cash in your pocket every month after paying all operating expenses, reserves, and mortgage debt service." />
              </span>
                  ...
                  <div className="divide-y divide-slate-100 text-xs">
                    ...
                    <div className="p-3.5 flex justify-between items-center bg-emerald-50/70 font-bold text-sm">
                      <span className="text-emerald-950 flex items-center gap-1.5">
                        ...
                        <InfoTooltip content="NOI strictly excludes debt service. This represents the true unleveraged earning power of the property." />
                      </span>
        ...
        <CalculatorFaqSection
          ...
          title="Rental Property & Cap Rate Frequently Asked Questions"
        />
