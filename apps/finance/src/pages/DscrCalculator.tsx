  ...
  return (
    <>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label htmlFor="dscr-loan-term" className="block text-xs font-semibold text-slate-700 mb-1.5">
                    Loan Term
                  </label>
                  <select id="dscr-loan-term"
                    value={loanTermYears}
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 border border-slate-200">
                ...
                {/*
                  This toggle's descriptive text lives in sibling <span>s rather
                  than inside a <label>, so it had no programmatic association.
                  aria-label supplies the accessible name.
                */}
                <input
                  type="checkbox"
                  aria-label="Interest-only loan"
        ...
        {!user && (
          <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-indigo-950 via-slate-900 to-indigo-950 text-white flex flex-col md:flex-row items-center justify-between gap-4 shadow-md border border-indigo-500/30 animate-in fade-in">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="text-sm font-extrabold text-white flex items-center gap-2">
                  <span>Save this DSCR scenario &amp; compare rental yields</span>
            ...
            <div className="flex items-center gap-2.5 shrink-0 w-full sm:w-auto">
              <button
                type="button"
                onClick={() => {
                  trackUserClick('dscr_inline_free_signup_click');
                  openAuthModal({
