    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs animate-in fade-in">
      <div className="relative w-full max-w-2xl bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[85vh]">
        ...
        <form onSubmit={handleSaveCurrent} className="p-4 bg-slate-50 border-b border-slate-200 flex items-center gap-3">
          ...
          <button
            type="submit"
            className="px-3.5 py-2 rounded-xl text-xs font-semibold inline-flex items-center gap-1.5 cursor-pointer shrink-0 bg-slate-900 hover:bg-slate-800 text-white shadow-xs transition-colors"
          >
