...
export const SeoSection = ({ toolConfig }: SeoSectionProps) => {
  ...
  return (
    <section className="w-full max-w-6xl mx-auto px-4 py-16 border-t border-slate-200 mt-6">
      ...
      <div className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="md:col-span-2 p-6 sm:p-8 rounded-2xl bg-white border border-slate-200 shadow-2xs hover:shadow-md transition-all flex flex-col justify-between relative overflow-hidden">
            <div>
              ...
              <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-xl mb-4">
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-white border border-slate-200 shadow-2xs hover:shadow-md transition-all flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 mb-3">
            ...
            <ul className="space-y-2.5 pt-3 border-t border-slate-100 text-sm text-slate-600">
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-white border border-slate-200 shadow-2xs hover:shadow-md transition-all flex flex-col justify-between">
            ...
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs font-mono text-slate-600 flex items-center justify-center gap-2 flex-wrap">
              <span className="text-emerald-700 font-semibold">.csv</span>
              <span>⇄</span>
              <span className="text-green-700 font-semibold">.xlsx</span>
              <span>⇄</span>
              <span className="text-indigo-700 font-semibold">.parquet</span>
              <span>⇄</span>
              <span className="text-amber-700 font-semibold">.json</span>
            </div>
          </div>

          {/* Card 4: Schema Profiling & DDL (Wide: 2 cols) */}
          <div className="md:col-span-2 p-6 sm:p-8 rounded-2xl bg-white border border-slate-200 shadow-2xs hover:shadow-md transition-all flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-xl">
                Inspect physical and logical column types, unique cardinality, minimum/maximum values, and null percentage metrics. Extract ready-to-run SQL DDL (<code className="text-cyan-700 font-mono">CREATE TABLE</code>) in a single click.
              </p>
            </div>

            <div className="mt-4 flex items-center gap-2 flex-wrap">
              <span className="px-3 py-1.5 rounded-lg bg-slate-100 border border-slate-200 text-xs font-mono text-slate-700">
                Data Types
              </span>
              <span className="px-3 py-1.5 rounded-lg bg-slate-100 border border-slate-200 text-xs font-mono text-slate-700">
                Null % Warnings
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <ArrowRight className="size-4 text-slate-400 group-hover:text-indigo-600 group-hover:translate-x-1 transition-all" />
                </div>
              ...
              <div className="mt-5 pt-3 border-t border-slate-100 text-xs font-semibold text-indigo-600 flex items-center gap-1.5">
