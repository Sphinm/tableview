...
export const FinancialHero = ({ onExploreClick }: FinancialHeroProps) => {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      {/* Hero Header Area */}
      <section className="pt-8 pb-6 md:pt-10 md:pb-8 text-center max-w-4xl mx-auto px-4 sm:px-6">
        {/* Version / Trust badge */}
        ...
        {/* Main Headline */}
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight leading-[1.15] [text-wrap:balance] mb-4">
        ...
        {/* Subtitle */}
        <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto mb-6 [text-wrap:pretty]">
