export interface SalaryLongTailPage {
  salary: number;
  slug: string;
  path: string;
  hourlyRate: string;
...
export const SALARY_LONG_TAIL_PAGES: SalaryLongTailPage[] = [
  {
    salary: 30000,
    slug: '30000-a-year-is-how-much-an-hour',
    path: '/30000-a-year-is-how-much-an-hour',
    hourlyRate: '14.42',
    biweekly: '1,153.85',
    monthly: '2,500.00',
  ...
  },
  {
    ...
    path: '/40000-a-year-is-how-much-an-hour',
    hourlyRate: '19.23',
    biweekly: '1,538.46',
    monthly: '3,333.33',
  ...
  {
    salary: 50000,
    slug: '50000-a-year-is-how-much-an-hour',
    path: '/50000-a-year-is-how-much-an-hour',
    hourlyRate: '24.04',
    biweekly: '1,923.08',
    monthly: '4,166.67',
  ...
  {
    salary: 60000,
    slug: '60000-a-year-is-how-much-an-hour',
    path: '/60000-a-year-is-how-much-an-hour',
    hourlyRate: '28.85',
    biweekly: '2,307.69',
    monthly: '5,000.00',
  ...
  {
    salary: 70000,
    slug: '70000-a-year-is-how-much-an-hour',
    path: '/70000-a-year-is-how-much-an-hour',
    hourlyRate: '33.65',
    biweekly: '2,692.31',
    monthly: '5,833.33',
  ...
  {
    salary: 75000,
    slug: '75000-a-year-is-how-much-an-hour',
    path: '/75000-a-year-is-how-much-an-hour',
    hourlyRate: '36.06',
    biweekly: '2,884.62',
    monthly: '6,250.00',
  ...
  {
    salary: 80000,
    slug: '80000-a-year-is-how-much-an-hour',
    path: '/80000-a-year-is-how-much-an-hour',
    hourlyRate: '38.46',
    biweekly: '3,076.92',
    monthly: '6,666.67',
  ...
  {
    salary: 90000,
    slug: '90000-a-year-is-how-much-an-hour',
    path: '/90000-a-year-is-how-much-an-hour',
    hourlyRate: '43.27',
    biweekly: '3,461.54',
    monthly: '7,500.00',
  ...
  {
    salary: 100000,
    slug: '100000-a-year-is-how-much-an-hour',
    path: '/100000-a-year-is-how-much-an-hour',
    hourlyRate: '48.08',
    biweekly: '3,846.15',
    monthly: '8,333.33',
  ...
  {
    salary: 120000,
    slug: '120000-a-year-is-how-much-an-hour',
    path: '/120000-a-year-is-how-much-an-hour',
    hourlyRate: '57.69',
    biweekly: '4,615.38',
    monthly: '10,000.00',
...
export const SALARY_LONG_TAIL_MAP: Record<string, SalaryLongTailPage> = Object.fromEntries(
  SALARY_LONG_TAIL_PAGES.map((p) => [p.path, p])
);

export const SALARY_LONG_TAIL_SLUG_MAP: Record<string, SalaryLongTailPage> = Object.fromEntries(
  SALARY_LONG_TAIL_PAGES.map((p) => [p.slug, p])
);
