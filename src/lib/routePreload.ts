...
const ROUTE_LOADERS: Record<string, ComponentLoader> = {
  ...
  '/1031-exchange-timeline-calculator': () => import('../pages/Section1031Calculator'),
  '/loan-comparison-calculator': () => import('../pages/LoanComparisonCalculator'),
  '/salary-to-hourly-calculator': () => import('../pages/SalaryCalculator'),
  '/snowflake-cost-calculator': () => import('../pages/SnowflakeCalculator'),
  '/parquet-storage-calculator': () => import('../pages/ParquetSavingsCalculator'),
  '/finance-calculator': () => import('../pages/FinanceCalculatorHub'),
  '/calculator': () => import('../pages/FinanceCalculatorHub'),
  ...
  // Data Tools Suite
  '/data-tools': () => import('../pages/DataToolsWorkbench'),
  '/data-converter': () => import('../pages/DataConverter'),
  '/json-formatter': () => import('../pages/JsonFormatter'),
  '/sql-formatter': () => import('../pages/SqlFormatter'),
  ...
  '/is-it-down': () => import('../pages/WebsiteStatusChecker'),
  '/ai-article-polisher': () => import('../pages/AiArticlePolisher'),
};
